...
export const useCategoryDetailStore = defineStore("category-details", () => {
  const products = ref([]);
  const categoryBackground = ref("");
  ...
  async function fetchAllProducts(id) {
    ...
    categoryBackground.value = data.data.categoryBackground;
    categoryDescription.value = data.data.categoryDescription;
